...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_MCUBOOT, 0x20000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_INIT_PRIORITY, 40);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NORDIC_QSPI_NOR_INIT_PRIORITY, 40);
