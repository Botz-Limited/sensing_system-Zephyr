...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_CMD_TX_SIZE, 125);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_EVT_RX_SIZE, 125);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_SIZE, 125);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_SIZE, 125);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DATA_LENGTH_MAX, 125);
