...
BT_GATT_SERVICE_DEFINE(
    ...
    BT_GATT_CHARACTERISTIC(&pace_sec_km_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_pace_sec_km_read,
    ...
    BT_GATT_CHARACTERISTIC(&distance_m_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_distance_m_read,
    ...
    BT_GATT_CHARACTERISTIC(&form_score_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_form_score_read,
    ...
    BT_GATT_CHARACTERISTIC(&balance_lr_pct_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_balance_lr_pct_read,
    ...
    BT_GATT_CHARACTERISTIC(&efficiency_score_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_efficiency_score_read,
                           nullptr,
    ...
    BT_GATT_CHARACTERISTIC(&alerts_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_alerts_read, nullptr,
    ...
    BT_GATT_CHARACTERISTIC(&flight_time_asym_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_flight_time_asym_read,
                           nullptr,
    ...
    BT_GATT_CHARACTERISTIC(&force_asym_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_force_asym_read,
    ...
    BT_GATT_CHARACTERISTIC(&pronation_asym_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_pronation_asym_read,
    ...
    BT_GATT_CHARACTERISTIC(&strike_left_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_strike_left_read,
    ...
    BT_GATT_CHARACTERISTIC(&strike_right_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_strike_right_read,
    ...
    BT_GATT_CHARACTERISTIC(&pronation_left_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_pronation_left_read,
    ...
    BT_GATT_CHARACTERISTIC(&pronation_right_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_pronation_right_read,
                           nullptr,
    ...
    BT_GATT_CHARACTERISTIC(&total_distance_m_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_total_distance_m_read,
                           nullptr,
    ...
    BT_GATT_CHARACTERISTIC(&avg_pace_sec_km_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_avg_pace_sec_km_read,
                           nullptr,
    ...
    BT_GATT_CHARACTERISTIC(&avg_cadence_spm_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_avg_cadence_spm_read,
                           nullptr,
    ...
    BT_GATT_CHARACTERISTIC(&total_steps_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_total_steps_read,
    ...
    BT_GATT_CHARACTERISTIC(&calories_kcal_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_calories_kcal_read,
    ...
    BT_GATT_CHARACTERISTIC(&avg_form_score_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_avg_form_score_read,
    ...
    BT_GATT_CHARACTERISTIC(&duration_sec_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_duration_sec_read,
    ...
    BT_GATT_CHARACTERISTIC(&stride_length_cm_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_stride_length_cm_read,
                           nullptr,
    ...
    BT_GATT_CHARACTERISTIC(&total_step_count_uuid.uuid,
                           BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                           BT_GATT_PERM_READ_ENCRYPT, ams_total_step_count_read,
                           nullptr,
