...
// Characteristic UUIDs for individual metrics (using same pattern as information service)
// Real-time Metrics individual UUIDs
...
// CCC (Client Characteristic Configuration) storage for individual characteristics
...
// Real-time Metrics
static ssize_t ams_cadence_spm_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_cadence_spm_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_pace_sec_km_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_pace_sec_km_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_distance_m_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_distance_m_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_form_score_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_form_score_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_balance_lr_pct_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_balance_lr_pct_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_ground_contact_ms_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_ground_contact_ms_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_flight_time_ms_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_flight_time_ms_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_efficiency_score_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_efficiency_score_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_alerts_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_alerts_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

// Asymmetry Metrics
static ssize_t ams_contact_time_asym_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_contact_time_asym_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_flight_time_asym_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_flight_time_asym_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_force_asym_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_force_asym_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_pronation_asym_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_pronation_asym_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_strike_left_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_strike_left_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_strike_right_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_strike_right_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

// Biomechanics Extended
static ssize_t ams_pronation_left_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_pronation_left_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_pronation_right_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_pronation_right_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_loading_rate_left_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_loading_rate_left_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_loading_rate_right_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_loading_rate_right_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_arch_collapse_left_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_arch_collapse_left_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_arch_collapse_right_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_arch_collapse_right_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

// Session Summary
static ssize_t ams_total_distance_m_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_total_distance_m_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_avg_pace_sec_km_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_avg_pace_sec_km_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_avg_cadence_spm_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_avg_cadence_spm_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_total_steps_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_total_steps_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_calories_kcal_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_calories_kcal_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_avg_form_score_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_avg_form_score_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

static ssize_t ams_duration_sec_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset);
static void ams_duration_sec_ccc_cfg_changed(const struct bt_gatt_attr *attr, uint16_t value);

// GPS Data write handler
static ssize_t ams_gps_data_write(struct bt_conn *conn, const struct bt_gatt_attr *attr, const void *buf, uint16_t len, uint16_t offset, uint8_t flags);
...
BT_GATT_SERVICE_DEFINE(
    ...
    BT_GATT_CHARACTERISTIC(&cadence_spm_uuid.uuid,
                          ...
                          ams_cadence_spm_read, nullptr,
                          static_cast<void *>(&cadence_spm_value)),
    ...
    BT_GATT_CHARACTERISTIC(&pace_sec_km_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_pace_sec_km_read, nullptr,
                          static_cast<void *>(&pace_sec_km_value)),
    ...
    BT_GATT_CHARACTERISTIC(&distance_m_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_distance_m_read, nullptr,
                          static_cast<void *>(&distance_m_value)),
    ...
    BT_GATT_CHARACTERISTIC(&form_score_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_form_score_read, nullptr,
                          static_cast<void *>(&form_score_value)),
    ...
    BT_GATT_CHARACTERISTIC(&balance_lr_pct_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_balance_lr_pct_read, nullptr,
                          static_cast<void *>(&balance_lr_pct_value)),
    ...
    BT_GATT_CHARACTERISTIC(&flight_time_ms_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_flight_time_ms_read, nullptr,
                          static_cast<void *>(&flight_time_ms_value)),
    ...
    BT_GATT_CHARACTERISTIC(&efficiency_score_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_efficiency_score_read, nullptr,
    ...
    BT_GATT_CHARACTERISTIC(&flight_time_asym_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_flight_time_asym_read, nullptr,
    ...
    BT_GATT_CHARACTERISTIC(&force_asym_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_force_asym_read, nullptr,
                          static_cast<void *>(&force_asym_value)),
    ...
    BT_GATT_CHARACTERISTIC(&pronation_asym_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_pronation_asym_read, nullptr,
                          static_cast<void *>(&pronation_asym_value)),
    ...
    BT_GATT_CHARACTERISTIC(&strike_left_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_strike_left_read, nullptr,
                          static_cast<void *>(&strike_left_value)),
    ...
    BT_GATT_CHARACTERISTIC(&strike_right_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_strike_right_read, nullptr,
                          static_cast<void *>(&strike_right_value)),
    ...
    BT_GATT_CHARACTERISTIC(&pronation_left_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_pronation_left_read, nullptr,
                          static_cast<void *>(&pronation_left_value)),
    ...
    BT_GATT_CHARACTERISTIC(&pronation_right_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_pronation_right_read, nullptr,
    ...
    BT_GATT_CHARACTERISTIC(&total_distance_m_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_total_distance_m_read, nullptr,
    ...
    BT_GATT_CHARACTERISTIC(&avg_pace_sec_km_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_avg_pace_sec_km_read, nullptr,
    ...
    BT_GATT_CHARACTERISTIC(&avg_cadence_spm_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_avg_cadence_spm_read, nullptr,
    ...
    BT_GATT_CHARACTERISTIC(&total_steps_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_total_steps_read, nullptr,
                          static_cast<void *>(&total_steps_value)),
    ...
    BT_GATT_CHARACTERISTIC(&calories_kcal_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_calories_kcal_read, nullptr,
                          static_cast<void *>(&calories_kcal_value)),
    ...
    BT_GATT_CHARACTERISTIC(&avg_form_score_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_avg_form_score_read, nullptr,
                          static_cast<void *>(&avg_form_score_value)),
    ...
    BT_GATT_CHARACTERISTIC(&duration_sec_uuid.uuid,
                          BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,
                          BT_GATT_PERM_READ_ENCRYPT,
                          ams_duration_sec_read, nullptr,
                          static_cast<void *>(&duration_sec_value)),
...
static ssize_t ams_arch_collapse_right_read(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset)
{
    return bt_gatt_attr_read(conn, attr, buf, len, offset, &arch_collapse_right_value, sizeof(arch_collapse_right_value));
}
...
void ams_update_realtime_metrics(const realtime_metrics_t *metrics)
{
    ...
    // Send notifications for individual real-time metrics if enabled and connected
    if (current_conn) {
        if (cadence_spm_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[2], &cadence_spm_value, sizeof(cadence_spm_value));
            if (err) LOG_WRN("Failed to send Cadence SPM notification: %d", err);
        }
        if (pace_sec_km_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[5], &pace_sec_km_value, sizeof(pace_sec_km_value));
            if (err) LOG_WRN("Failed to send Pace Sec/Km notification: %d", err);
        }
        if (distance_m_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[8], &distance_m_value, sizeof(distance_m_value));
            if (err) LOG_WRN("Failed to send Distance M notification: %d", err);
        }
        if (form_score_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[11], &form_score_value, sizeof(form_score_value));
            if (err) LOG_WRN("Failed to send Form Score notification: %d", err);
        }
        if (balance_lr_pct_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[14], &balance_lr_pct_value, sizeof(balance_lr_pct_value));
            if (err) LOG_WRN("Failed to send Balance L/R Pct notification: %d", err);
        }
        if (ground_contact_ms_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[17], &ground_contact_ms_value, sizeof(ground_contact_ms_value));
            if (err) LOG_WRN("Failed to send Ground Contact MS notification: %d", err);
        }
        if (flight_time_ms_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[20], &flight_time_ms_value, sizeof(flight_time_ms_value));
            if (err) LOG_WRN("Failed to send Flight Time MS notification: %d", err);
        }
        if (efficiency_score_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[23], &efficiency_score_value, sizeof(efficiency_score_value));
            if (err) LOG_WRN("Failed to send Efficiency Score notification: %d", err);
        }
        if (alerts_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[26], &alerts_value, sizeof(alerts_value));
            if (err) LOG_WRN("Failed to send Alerts notification: %d", err);
        }
    }
    ...
    // Send notifications for individual asymmetry metrics if enabled and connected
    if (current_conn) {
        if (contact_time_asym_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[29], &contact_time_asym_value, sizeof(contact_time_asym_value));
            if (err) LOG_WRN("Failed to send Contact Time Asymmetry notification: %d", err);
        }
        if (flight_time_asym_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[32], &flight_time_asym_value, sizeof(flight_time_asym_value));
            if (err) LOG_WRN("Failed to send Flight Time Asymmetry notification: %d", err);
        }
        if (force_asym_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[35], &force_asym_value, sizeof(force_asym_value));
            if (err) LOG_WRN("Failed to send Force Asymmetry notification: %d", err);
        }
        if (pronation_asym_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[38], &pronation_asym_value, sizeof(pronation_asym_value));
            if (err) LOG_WRN("Failed to send Pronation Asymmetry notification: %d", err);
        }
        if (strike_left_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[41], &strike_left_value, sizeof(strike_left_value));
            if (err) LOG_WRN("Failed to send Strike Left notification: %d", err);
        }
        if (strike_right_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[44], &strike_right_value, sizeof(strike_right_value));
            if (err) LOG_WRN("Failed to send Strike Right notification: %d", err);
        }
    }
}
...
void ams_update_biomechanics_extended(const biomechanics_extended_ble_t *data)
{
    ...
    // Send notifications for individual biomechanics extended metrics if enabled and connected
    if (current_conn) {
        if (pronation_left_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[47], &pronation_left_value, sizeof(pronation_left_value));
            if (err) LOG_WRN("Failed to send Pronation Left notification: %d", err);
        }
        if (pronation_right_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[50], &pronation_right_value, sizeof(pronation_right_value));
            if (err) LOG_WRN("Failed to send Pronation Right notification: %d", err);
        }
        if (loading_rate_left_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[53], &loading_rate_left_value, sizeof(loading_rate_left_value));
            if (err) LOG_WRN("Failed to send Loading Rate Left notification: %d", err);
        }
        if (loading_rate_right_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[56], &loading_rate_right_value, sizeof(loading_rate_right_value));
            if (err) LOG_WRN("Failed to send Loading Rate Right notification: %d", err);
        }
        if (arch_collapse_left_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[59], &arch_collapse_left_value, sizeof(arch_collapse_left_value));
            if (err) LOG_WRN("Failed to send Arch Collapse Left notification: %d", err);
        }
        if (arch_collapse_right_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[62], &arch_collapse_right_value, sizeof(arch_collapse_right_value));
            if (err) LOG_WRN("Failed to send Arch Collapse Right notification: %d", err);
        }
    }
}
...
void ams_update_session_summary(const session_summary_ble_t *summary)
{
    ...
    // Send notifications for individual session summary metrics if enabled and connected
    if (current_conn) {
        if (total_distance_m_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[65], &total_distance_m_value, sizeof(total_distance_m_value));
            if (err) LOG_WRN("Failed to send Total Distance M notification: %d", err);
        }
        if (avg_pace_sec_km_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[68], &avg_pace_sec_km_value, sizeof(avg_pace_sec_km_value));
            if (err) LOG_WRN("Failed to send Avg Pace Sec/Km notification: %d", err);
        }
        if (avg_cadence_spm_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[71], &avg_cadence_spm_value, sizeof(avg_cadence_spm_value));
            if (err) LOG_WRN("Failed to send Avg Cadence SPM notification: %d", err);
        }
        if (total_steps_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[74], &total_steps_value, sizeof(total_steps_value));
            if (err) LOG_WRN("Failed to send Total Steps notification: %d", err);
        }
        if (calories_kcal_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[77], &calories_kcal_value, sizeof(calories_kcal_value));
            if (err) LOG_WRN("Failed to send Calories Kcal notification: %d", err);
        }
        if (avg_form_score_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[80], &avg_form_score_value, sizeof(avg_form_score_value));
            if (err) LOG_WRN("Failed to send Avg Form Score notification: %d", err);
        }
        if (duration_sec_notify_enabled) {
            int err = bt_gatt_notify(current_conn, &activity_metrics_service.attrs[83], &duration_sec_value, sizeof(duration_sec_value));
            if (err) LOG_WRN("Failed to send Duration Sec notification: %d", err);
        }
    }
}
...
void ams_set_connection(struct bt_conn *conn)
{
    ...
    if (!conn) {
        // Connection lost, reset notification states for all individual characteristics
