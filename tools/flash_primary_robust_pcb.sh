...
if [ -f "build_primary_pcb/merged_CPUNET.hex" ]; then
    nrfjprog --program build_primary_pcb/merged_CPUNET.hex --verify -f NRF53 --coprocessor CP_NETWORK
...
nrfjprog --program build_primary_pcb/merged.hex --verify -f NRF53 --coprocessor CP_APPLICATION
